...
class TestPasswordResetInitiate:
    ...
    def test_secure_version(self) -> None:
        ...
        assert response == {
            "statusCode": 200,
            "body": '{"reset_link": "https://localhost:8080/demo/host-header-injection/password-reset/complete/?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAZXhhbXBsZS5jb20iLCJleHAiOjE3MzY5NTA1MDAuMH0.u_Jq2ySry2eme_RQkktBJTsUZ0lBbcqNh4xA_-1Xcro"}',
        }
