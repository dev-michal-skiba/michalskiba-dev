...
window.onload = function() {
    document.getElementById("version-switch").checked = window.getIsSecureVersionOn();

    const passwordResetInitiateForm = document.getElementById("password-reset-initiate-form");
    ...
    const submitPasswordResetInitiateButton = document.getElementById("submit-password-reset-initiate-button");
    ...
    const submitPasswordResetButton = document.getElementById("submit-password-reset-button");
